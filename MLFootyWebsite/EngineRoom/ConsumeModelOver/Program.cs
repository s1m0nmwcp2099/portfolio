...
namespace ConsumeModelResult
{
    class Program
    {
        public static void ConsumeModel(ModelInput _inputData, float[] _probs){
            ...
            ITransformer mlModel=mlContext.Model.Load("../ModelCliOver/SampleClassification/SampleClassification.Model/MLModel.zip", out var inputSchema);
            ...
            if (_thisMatchProbs.TryGetValue("Y", out float prob0)){
                _probs[0]=prob0;
            }
            if (_thisMatchProbs.TryGetValue("N", out float prob1)){
                _probs[1]=prob1;
            }
        }
        ...
        static void Main(string[] args)
        {
            ...
            AllProbabilities.Add("league,date,home,away,p(Over),p(Under),Over");
            ...
            for (int i=0; i<fixtureDf.Rows.Count; i++){
                ...
                float[] thisMatchProbs=new float[2];
            ...
            string fName = "../Data/PredictionsOvers.csv";

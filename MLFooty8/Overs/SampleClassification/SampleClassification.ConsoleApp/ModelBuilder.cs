...
namespace SampleClassification.ConsoleApp
{
    public static class ModelBuilder
    {
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.MulticlassClassification.Trainers.OneVersusAll(mlContext.BinaryClassification.Trainers.FastForest(numberOfLeaves: 6, minimumExampleCountPerLeaf: 1, numberOfTrees: 100, labelColumnName: "Over", featureColumnName: "Features"), labelColumnName: "Over")

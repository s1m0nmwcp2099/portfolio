...
namespace SampleMulticlassClassification.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"/home/me/GithubRepo/portfolio/MLFooty8/Data/processedData.csv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.MulticlassClassification.Trainers.OneVersusAll(mlContext.BinaryClassification.Trainers.SgdCalibrated(new SgdCalibratedTrainer.Options() { L2Regularization = 1E-06f, ConvergenceTolerance = 1E-05f, NumberOfIterations = 10, Shuffle = true, LabelColumnName = "FTR", FeatureColumnName = "Features" }), labelColumnName: "FTR")
